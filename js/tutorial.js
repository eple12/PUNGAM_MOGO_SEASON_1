...
const Tutorial = (() => {
  ...
  const STEPS = [
    {
      title: '① 문제 읽기 · 필기',
      body: '문제지에는 펜으로 직접 풀이를 적을 수 있습니다. 아래 연습 문제 위에 펜으로 자유롭게 써 보세요.<br>' +
            '잘못 썼다면 <b>획 지우개</b>를 고른 뒤 지우고 싶은 획을 다시 누르면 지워집니다.<br>' +
            '<b>손가락 필기</b>는 기본적으로 꺼져 있어 손이 스쳐도 그려지지 않습니다 — 스타일러스가 없어 손가락으로 써야 할 때만 켜세요.',
      spot: ['#tutPaperScroll', '.screen#screenTutorial .tools']
    },
    {
      title: '② 문항 이동',
      body: '실제 시험은 문항이 여러 개입니다.<br>◀ ▶ 버튼으로 옆 문항으로 옮겨 다닐 수 있으며, 가운데 <b>번호 버튼</b>을 누르면 ' +
            '문항 목록이 열려 원하는 문항으로 바로 건너뛰거나 <b>현재 문항 필기 지우기</b>도 한 번에 할 수 있습니다.<br>' +
            '▶ 로 2번까지 가 본 뒤, 번호 버튼을 눌러 목록에서 다시 1번으로 이동해 보세요.',
      spot: ['.screen#screenTutorial .topbar__group--center']
    },
    {
      title: '③ OMR 답안지에 마킹하기',
      body: '오른쪽 귀퉁이의 <b>OMR</b> 탭을 눌러 답안지를 열어 보세요.<br>예시 1번의 정답 <b>32</b>는 십의 자리에 3, ' +
            '일의 자리에 2를(백의 자리는 비워 둠), 예시 2번의 정답 <b>25</b>는 십의 자리에 2, 일의 자리에 5를 표기하면 됩니다.<br>' +
            '<b>실제 시험은 화면에 마킹된 것만 채점되므로, 풀이는 필기로 남기고 답은 반드시 OMR에 표기해야 합니다.</b>',
      spot: ['#tutOmrTab']
    }
  ];
